...
function foundBrand(title, ...args) {
    ...
    const brands = [
        ...
        { canonical: 'Louis Vuitton', variants: ['Louis Vuitton', 'LV', 'Lv', 'L.v', 'LVLV', 'LouisVuitton', 'lv-', '', 'LOUIS VUITTON', 'L驴', 'louis vuitton', '*OUIS *', 'LOUI VUITTO', 'LOUIS UITTO', 'OUIS UITTO', '＊OUIS ＊UITTO＊', 'OUIS UITTO', '＊OUIS', '＊UITTO＊',   'Louis V ', 'LOUI VUITTO', 'LOUI', 'VUITTO', '路易威登', 'L家', 'L经', 'L家巴黎', 'L经巴黎', 'L家', 'L经'] },
        ...
        { canonical: 'Fendi', variants: ['Fendi', 'Fendi Roma', 'FendiRoma', 'FENDI', 'fendi', '', '', 'FD', '', 'FEND', 'Fedi', 'Fe*di', '芬迪', '芬迪巴黎', '芬～'] },
        ...
        { canonical: 'Loro Piana', variants: ['Loro Piana', 'LORO PIANA', 'LoroPiana', 'LORO ', '', 'LORO', 'loro', 'Lp', 'LP', '罗洛·皮亚纳']},
        ...
        { canonical: 'Versace', variants: ['Versace', 'Gianni Versace', 'Versace Italy', 'VERACE', 'versace', '', '范思哲', '范思哲巴黎', '范～'] },
        ...
        { canonical: 'Boss', variants: ['Boss', 'BOSS', 'Hugo Boss', 'HugoBoss', 'BOOS', 'boss', '', '', 'BO' , 'bo', '博斯', '博斯巴黎', '博～', 'ＢＯＳＳ'] },
        ...
        { canonical: 'Thom Browne', variants: ['Thom Browne', 'Thom Browne', 'Thom Browne', 'THOM BROWNE', 'TH0M BR0WNE', 'thom browne', 'THOM ', '', 'TB', '汤姆·布朗']},
        ...
        { canonical: 'Dolce & Gabbana', variants: ['Dolce & Gabbana', 'Dolce Gabbana', 'D&G', 'DolceGabbana','DGdg', 'DG', 'dg', '', '', 'G logo', 'GG', 'G家', '杜嘉班纳'] },
        ...
        { canonical: 'Christian Louboutin', variants: ['Christian Louboutin', 'Louboutin', 'ChristianLouboutin', 'CHRISTIAN LOUBOUTIN', 'christian louboutin', 'CHRISTIAN ', '', 'CL', 'CL～高端男士红底鞋', '克里斯提·鲁布托', '克里斯提·鲁布托巴黎', '克～']},
        { canonical: 'Lacoste', variants: ['Lacoste', 'LACOSTE', 'LACOSTE', 'lacoste', '', '', '鳄鱼', '鳄鱼巴黎', '鳄～', '🐢🐢男装男鞋']},
        ...
        { canonical: 'Common Projects', variants: ['Common Projects', 'Common Projects', 'Common Projects', 'COMMON PROJECTS', 'common projects', 'COMMON ', '', 'CP', 'cp', 'CP～', 'cp～', 'CP', 'cp', 'CP～', 'cp～']},
        ...
        { canonical: 'Rick Owens', variants: ['Rick Owens', 'Rick Owens', 'Rick Owens', 'RICK OWENS', 'rick owens', 'RICK ', '', 'RO', 'ro', 'RO～', 'ro～', 'RO', 'ro', 'RO～', 'ro～', '欧～']}
    ];
