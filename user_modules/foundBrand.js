...
function foundBrand(title) {
    ...
    const brands = [
        ...
        { canonical: 'Hermes', variants: ['Hermes', 'Hermès', 'Hermes Paris', 'HERMES', 'HermesParis', 'HERME', 'HERMESTPR', 'HERMES HERMES', 'HER MES', 'HERME Bouncing', 'Bouncing', 'HERME Bouncing', 'Bouncing', '爱马仕', '爱马仕巴黎', '爱～', 'H高', 'H 🔍'] },
        ...
        { canonical: 'Moncler', variants: ['Moncler', 'MONCLER', 'Moncler', 'moncler', 'MONCLER*', 'Moncler*', 'moncler', 'Moncle', 'Moncle*', '蒙克莱', '蒙克莱巴黎', '蒙～', 'monc', '毛里订做']},
        ...
        { canonical: 'Chanel', variants: ['Chanel', 'CHANEL', 'Chanel Paris', 'Chanel', 'chanel', 'CHANEL*', 'Chanel*', '香奈儿', '香奈儿巴黎', '香～', '香奈儿', '香奈儿巴黎', '香～', 'Chnel']},
        ...
        { canonical: 'Balmain', variants: ['Balmain', 'BALMAIN', 'Balmain', 'balmain', 'BALMAIN*', 'Balmain*', '巴尔曼', '巴尔～']},
        ...
        { canonical: 'Burberry', variants: ['Burberry', 'Burberry London', 'Burberry London', 'BURBERRY', 'BURBERR', 'Vintage', 'burberry', 'BURB*', 'Burb*', 'Burrberr*', '博柏利', '博柏利巴黎', '博～', '博柏利', '巴宝莉', '巴宝莉巴黎', '巴～', '宝～', 'B家'] },
        { canonical: 'Valentino', variants: ['Valentino', 'Valentino Garavani', 'ValentinoGaravani', 'VALENTINO', 'valentino', 'VALENTIN*', 'Valentin*', 'VLTN', '华伦天奴', '华伦天奴巴黎', '华～', '伦～']},
        ...
        { canonical: 'Berluti', variants: ['Berluti', 'Berluti', 'Berluti', 'BERLUTI', 'berluti', 'BERLUTI*', 'Berluti*', 'Berlut', '布鲁提*',  '伯尔鲁帝', '伯尔鲁帝巴黎', '伯～', '布鲁提', '布鲁～']},
        { canonical: 'Christian Louboutin', variants: ['Christian Louboutin', 'Louboutin', 'ChristianLouboutin', 'CHRISTIAN LOUBOUTIN', 'christian louboutin', 'CHRISTIAN LOUBOUTIN*', 'ChristianLouboutin*', 'CL', 'CL～高端男士红底鞋', '克里斯提·鲁布托', '克里斯提·鲁布托巴黎', '克～']},
        { canonical: 'Lacoste', variants: ['Lacoste', 'LACOSTE', 'LACOSTE', 'lacoste', 'LACOSTE*', 'Lacoste*', '鳄鱼', '鳄鱼巴黎', '鳄～', '🐢🐢男装男鞋']},
        { canonical: 'Karl Lagerfeld', variants: ['Karl Lagerfeld', 'Karl Lagerfeld', 'Karl Lagerfeld', 'KARL LAGERFELD', 'karl lagerfeld', 'KARL LAGERFELD*', 'KarlLagerfeld*', '卡尔·拉格斐', '卡尔·拉格斐巴黎', '卡尔～', '卡尔', '卡尔巴黎', '卡尔经', '卡尔经巴黎', '卡尔经', '情侣款']},
        { canonical: 'Converse', variants: ['Converse', 'Converse', 'Converse', 'CONVERSE', 'converse', 'CONVERSE*', 'Converse*', '匡威', '匡威巴黎', '匡～', '匡～', '匡威', '匡威巴黎', '匡～', '匡～']},
        { canonical: 'Common Projects', variants: ['Common Projects', 'Common Projects', 'Common Projects', 'COMMON PROJECTS', 'common projects', 'COMMON PROJECTS*', 'CommonProjects*', 'CP', 'cp', 'CP～', 'cp～', 'CP', 'cp', 'CP～', 'cp～']},
        { canonical: 'Zara', variants: ['Zara', 'ZARA', 'Zara', 'zara', 'ZARA*', 'Zara*', '扎拉', '扎拉巴黎', '扎～']},
        { canonical: 'Premiata', variants: ['Premiata', 'Premiata', 'Premiata', 'PREMIATA', 'premiata', 'PREMIATA*', 'Premiata*', 'PRM', 'prm', 'PRM～', 'prm～', 'PRM', 'prm', 'PRM～', 'prm～']},
        { canonical: 'Rick Owens', variants: ['Rick Owens', 'Rick Owens', 'Rick Owens', 'RICK OWENS', 'rick owens', 'RICK OWENS*', 'RickOwens*', 'RO', 'ro', 'RO～', 'ro～', 'RO', 'ro', 'RO～', 'ro～', '欧～']}
    ];
